...
const projects = [
  ...
  { number: "02", title: "EcomGrove", label: "E-commerce platform", description: "A commerce product connecting a customer storefront, an administration portal, and a consistent typed data flow from interface to API.", highlights: ["Stripe and SePay payment gateways with webhook-based confirmation and state machine-driven order status updates", "JWT and RBAC authorization", "Redis caching for backend workloads", "Next.js SSR for product pages"], tech: ["Next.js", "TypeScript", "NestJS", "Stripe", "SePay", "Redis"], github: "https://github.com/keithz23/EcomGrove", icon: ShoppingBagOpen },
    ...
    <div className="system-canvas" aria-hidden="true">
      ...
      <div className="p-5 sm:p-7">
        ...
        <div className="mt-3 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
          <div className="commerce-node"><span>03</span><p>Payment webhook</p></div><ArrowUpRight size={16} weight="regular" className="rotate-45 text-zinc-400" /><div className="commerce-node border-blue-600/50 dark:border-blue-400/50"><span>04</span><p>Order state</p></div>
        </div>
      </div>
    </div>
  );
