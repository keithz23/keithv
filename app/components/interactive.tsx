        ...
        <div className="relative">
          <div className="stagger-item mb-10 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-zinc-500 dark:text-zinc-400">
            <span className="status-line">
              <span className="status-dot" /> Available for selected
              opportunities
            </span>
            <span className="inline-flex items-center gap-1.5">
              <MapPin size={15} weight="regular" /> Ho Chi Minh City, Vietnam
            </span>
          </div>
          ...
          <p className="stagger-item mt-8 max-w-[61ch] text-pretty text-lg leading-8 text-zinc-600 dark:text-zinc-300">
            I&apos;m Keith Vuong. I build secure APIs, responsive interfaces,
            and cloud-ready systems for products that need to work clearly and
            reliably—not just look finished.
          </p>
